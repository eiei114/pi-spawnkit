...
Releases publish **`pi-spawnkit`** to npm through Trusted Publishing. Do not add `NPM_TOKEN` to GitHub Secrets.
...
See `docs/release.md` for Trusted Publisher settings and the publish workflow.