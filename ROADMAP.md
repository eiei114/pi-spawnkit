...
Status: **doctor walking skeleton, resolver, and smoke diagnostics shipped**

`/spawnkit:doctor` is implemented with structured PATH diagnostics, resolver candidates, the selected SpawnPlan, and bounded spawn smoke diagnostics. Process-local PATH patching remains planned.
